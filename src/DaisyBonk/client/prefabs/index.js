...
export function makePortal() {
    ...
    const _tex = (file)=>{ const t=_loader.load("./assets/textures/prefab-3/" + file); t.wrapS=t.wrapT=THREE.RepeatWrapping; return t; };
    const prefabroot1 = new THREE.Group();
    prefabroot1.name = "PrefabRoot";
    g.add(prefabroot1);
    const torus2 = new THREE.Mesh(
        new THREE.TorusGeometry(0.5, 0.2, 16, 24, 6.283185),
        new THREE.MeshPhysicalMaterial({ color:0xce0909, metalness:0.25, roughness:0.9 })
    );
    torus2.scale.set(3, 3, 1);
    torus2.name = "Torus";
    g.add(torus2);
    {
        const _m = torus2.material;
        const _t = _tex("image.jpg");
        _t.repeat.set(1, 1);
        _t.offset.set(0, 0);
        _m.map = _t; _m.needsUpdate = true;
    }
    const sphere3 = new THREE.Mesh(
        new THREE.SphereGeometry(0.5, 16, 12),
        new THREE.MeshStandardMaterial({ color:0x10b9da, metalness:0, roughness:0.9 })
    );
...
// Auto-generated by DaisyBonk Prefab Editor on 2025-10-17T01:05Z
// Prefab ID: prefab-3 • Type:  • Author:
export function makePrefab3Mesh(){
    const g = new THREE.Group();
    const _loader = new THREE.TextureLoader();
    const _tex = (file)=>{ const t=_loader.load("./assets/textures/prefab-3/" + file); t.wrapS=t.wrapT=THREE.RepeatWrapping; return t; };
    const prefabroot1 = new THREE.Group();
